...
describe('[N] Ontology Classification', function () {
...
describe('[N] INSERT query with subsumption', function () {
    var query, results;
...
describe('[N] Re-INSERT exact same query', function () {
    var query;
...
describe('[N] DELETE query with subsumption', function () {
    var query, results;
